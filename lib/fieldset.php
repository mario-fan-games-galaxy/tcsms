...
class fieldset
{
    ...
    public function addField($type, $title, $data=array())
    {
    ...
    public function appendField($type, $data)
    {
        $newdata = $this->switchtype($type, $data);
    ...
    public function appendTitle($type, $data)
    {
        $newdata = $this->switchtype($type, $data);
    ...
    public function infoBlock($id, $data)
    {
    ...
    public function startSubset($ssid)
    {
        $this->in_subset = 1;
        $this->subset_cnt = 0;
        $this->subset_id = $ssid;
    ...
    public function switchtype($type, &$data)
    {
        switch ($type) {
    ...
    public function proc_checkbox(&$data)
    {
    ...
    public function proc_checkboxlist(&$data)
    {
        $html = '';
    ...
    public function proc_link(&$data)
    {
        global $CFG, $STD;
    ...
    public function proc_visiconlink(&$data)
    {
        global $STD;
    ...
    public function proc_csvbox(&$data)
    {
        $tags = @join(',', $data['v']);
    ...
    public function proc_csvlinks(&$data)
    {
        $html = '';
        sort($data['v']);
        reset($data['v']);
    ...
    public function proc_image(&$data)
    {
        $html = "<img src='{$data['v']}' border='0' alt='image' />";
        return $html;
    }
    
    public function proc_infoicon(&$data)
    {
    ...
    public function proc_file(&$data)
    {
        $html = "<input type='file' name='{$data['name']}' class='textbox' size='40' />";
        return $html;
    }
    
    public function proc_hidden(&$data)
    {
