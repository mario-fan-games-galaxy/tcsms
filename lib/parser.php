...
class parser
{
    ...
    public function convert_image($matches)
    {
        global $STD;
    ...
    public function convert_email($matches)
    {
        global $STD;
    ...
    public function convert_quote($matches)
    {
        global $STD, $CFG;
    ...
    public function convert_quote_open_l1($matches)
    {
        global $STD;
    ...
    public function convert_quote_open_l2($matches)
    {
        global $STD, $CFG;
    ...
    public function convert_quote_close($matches)
    {
        global $STD;
    ...
    public function unconvert_quote($matches)
    {
        global $STD;
