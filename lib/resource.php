...
class resource extends table_frame
{
    ...
    public function query_use($item, $value=null)
    {
        global $STD;
    ...
    public function create_ghost($fields=array(), $auxdata=array())
    {
        global $STD, $DB, $CFG, $TAG;
    ...
    public function update_ghost($fields=array())
    {
        global $STD, $DB, $CFG;
    ...
    public function like_search_all($string)
    {
        global $STD, $DB, $CFG;
    ...
    public function like_search_count($string)
    {
        global $STD, $DB, $CFG;
    ...
    public function full_text_search_all($string, $boolean)
    {
        global $STD, $DB, $CFG;
    ...
    public function full_text_search_count($string, $boolean)
    {
        global $STD, $DB, $CFG;
    ...
    public function format_username_simple($row)
    {
        $user = '<b>N/A</b>';
