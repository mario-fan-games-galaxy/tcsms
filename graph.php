...
class piechart
{
    public $center_x         = 0;
    public $center_y         = 0;
    public $circle_width     = 0;
    public $circle_height    = 0;
    public $image_width      = 0;
    public $image_height     = 0;
    public $colors           = array();
    public $colors_data      = array();
    public $split_chart      = false;
    public $segment_data     = array();
    
    public $image            = 0;
    public $last_arc         = 0;
    
    public function init($serial_data)
    {
    ...
    public function CreateSegment($sr)
    {
        // generate color key
    ...
    public function addLegendEntry($sr)
    {
