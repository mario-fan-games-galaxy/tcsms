...
<div class="menusection">
  ...
  <div class="menuitem"><a href="{$STD->tags['root_url']}act=main&amp;param=08">Updates Archive</a></div>
  ...
  <div class="menuitem"><a href="https://forums.mfgg.net/">Message Board</a></div>
  <div class="menuitem"><a href="https://wiki.mfgg.net/">Wiki</a></div>
</div>
...
<div class="menusection" style="text-align:center">
  <div class="menuitem"><a href="http://sprites-inc.co.uk/" target="_blank">
    <img src="template/images/sprites_inc.gif" alt="Sprites INC." width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="https://gamingreinvented.com/" target="_blank">
    <img src="template/images/gr.png" alt="Gaming Reinvented" width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="http://thesaplingforums.com/" target="_blank">
    <img src="template/images/sapling.jpg" alt="The Sapling Forums" width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="http://sm64hacks.com" target="_blank">
    <img src="template/images/sm64hacks.png" alt="SM64 Hacks" width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="http://www.supermariobrosx.org/" target="_blank">
    <img src="template/images/smbx.gif" alt="Super Mario Bros. X" width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="http://www.smwcentral.net/" target="_blank">
    <img src="template/images/smwc.gif" alt="SMW Central" width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="http://talkhaus.raocow.com/" target="_blank">
    <img src="template/images/talkhaus.png" alt="Raocow's Talkhaus" width="88" height="31" border="0"></a></div>
  <div class="menuitem"><a href="http://www.superluigibros.com/" target="_blank">
    <img src="template/images/slb.png" alt="Super Luigi Bros." width="88" height="31" border="0"></a></div>
  ...
  <!--<div class="menuitem"><a href="http://www.metroidhq.com/" target="_blank">
...
<div class="menusection">
  <div class="menuitem">
    <input type="text" name="username" placeholder="username" alt="username" size="13" class="sidetextbox" /></div>
  <div class="menuitem">
    <input type="password" name="password" placeholder="password" alt="password" size="13" class="sidetextbox" /></div>
...
HTML;
    ...
    public function page_header($title)
    {
        global $STD;
        return <<<HTML
<div class="header_region"><script>document.title="{$title} - MFGG - Mario Fan Games Galaxy"; //i'm sorry this is terrible</script>
<table border="0" cellspacing="0" cellpadding="0" style="width:100%; margin-left: auto; margin-right: auto"><tr>
...
<tr>
  ...
  <td align="center">
  <br />
  <div class="canvas_center copyright">
    ...
    <br /><br />
    <div style="text-align:center">Powered By: Taloncrossing SMS v0.8.5, &copy; 2008 <a href='https://www.taloncrossing.com' class='outlink'>Taloncrossing.com</a></div>
  </div>
  </td>
</tr>
</table>
