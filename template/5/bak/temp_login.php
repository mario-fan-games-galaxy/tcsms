...
<tr>
  ...
  <td class="sformright"><input type="text" name="username" size="40" class="textbox" />
    <a href="{$STD->tags['root_url']}act=login&amp;param=09">I forgot my username</a></td>
</tr>
</table>
...
HTML;
    ...
    public function lost_username($reg_url, $token)
    {
        global $STD;
        return <<<HTML
<div class="sform">
<form method="post" action="{$reg_url}">
<input type="hidden" name="security_token" value="{$token}" />
<div class="sformstrip">Recover from a lost username and password</div>
<div class="sformblock">Use this form to change your password if you've forgotton it.  A link to a page where you can
  choose a new password will be emailed to the address you provide, if it's on record.
</div>
<div class="sformstrip">Fill out the form below</div>
<table class="sformtable">
<tr>
  <td class="sformleft">Your email address</td>
  <td class="sformright"><input type="text" name="email" size="40" class="textbox" /></td>
</tr>
</table>
<div class="sformstrip" style="text-align:center"><input type="submit" value="Submit" class="button" /></div>
