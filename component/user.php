...
class component_user
{
    ...
    public function show_ucp_prefs()
    {
    ...
    public function show_manage_sub_list()
    {
    ...
    public function show_manage_item()
    {
        global $STD, $DB, $IN, $CFG;
    ...
    public function do_manage_item()
    {
        global $STD, $DB, $IN, $CFG;
