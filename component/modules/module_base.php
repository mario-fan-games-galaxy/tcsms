...
{
    public $extable			= '';
    public $file_restrictions	= array();
    
    public function check_file_restrictions($file, $type, $ecode='')
    {
        global $STD, $TPL;
    ...
    public function move_file($file, $type, $ecode='')
    {
        global $IN, $STD, $TPL;
    ...
    public function mime_check($file, $name='', $mime='')
    {
        global $STD;
    ...
    public function format_filesize($file)
    {
        $size = filesize($file);
    ...
    public function get_thumbnail(&$row, $skin='')
    {
        global $CFG, $IN, $STD;
    ...
    public function get_image(&$row, $type)
    {
        global $CFG, $IN;
    ...
    public function get_filesize(&$row)
    {
        global $CFG, $IN;
    ...
    public function build_thumbnail($src, $dest, $width, $height, $minwidth=0, $minheight=0)
    {
        global $STD;
    ...
    public function get_version_history($rid)
    {
        global $CFG, $DB;
    ...
    public function format_username(&$row, $prefix='')
    {
        global $STD;
    ...
    public function add_filters($resid, $data)
    {
        global $CFG, $DB;
    ...
    public function clear_filters($resid)
    {
        global $CFG, $DB;
    ...
    public function make_catwords($resid)
    {
    ...
    public function parse_keywords($keywords)
    {
    ...
    public function make_catset($gkey, &$data, $def=array())
    {
        global $IN, $STD;
    ...
    public function make_catsetmulti($gkey, &$data, $def=array())
    {
        global $IN, $STD;
    ...
    public function mod_action(&$RES, $code)
    {
        // a  : accept
        // au : accept user-mod
        // d  : decline
